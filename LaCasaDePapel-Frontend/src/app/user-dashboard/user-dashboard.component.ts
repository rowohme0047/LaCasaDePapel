...
submitDeleteAccount() {
  ...
  Id       : ${this.userId}
  Name     : ${this.firstName} 
  Acc no   : ${this.accountNum}
  Reason   :
`;
const finalReason = predefinedText +'\n'+ this.deleteReason;
  if (confirm('Are you sure you want to delete your account?')) {
    this.sharedService.sendMessage(finalReason);
    this.deleteReason = '';
    window.alert("Your account deletion has been intialized")
  }
}
showDeleteWarning(){
